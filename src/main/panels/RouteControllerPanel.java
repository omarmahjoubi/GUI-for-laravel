...
public class RouteControllerPanel extends JPanel {
    ...
    public RouteControllerPanel(MainFrame frame) {
        ...
        JPanel[][] emptyPanels = new JPanel[6][2];
        for (int m = 0; m < 6; m++) {
            for (int l = 0; l < 2; l++) {
